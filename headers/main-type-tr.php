              ...
              <div class="container mx-auto p-3">
                <div class="flex items-center justify-between">
                  ...
                  <div class="hidden lg:flex space-x-6">
                    ...
                    <img src="./public/icon/tr.svg" class="w-4 h-4 rounded-full object-cover mt-1 mr-1" alt="Türkçe">TR
                    <div id="dropdown-menu" class="absolute flex-col rounded-full items-center text-black self-end py-8 space-y-6 font-bold bg-white sm:w-auto sm:self-center drop-shadow-md md:w-28 flex none" style="bottom: -200px; right: 3%;">
                        <a class="link flex items-center" style="margin-top: 5px;"><img src="./public/icon/tr.svg" class="w-10 h-10 ml-5 mr-1 rounded-full object-cover" alt="Türkçe" onclick="toggleDropdown()">TR</a>
                        <a href="?lang=eng" class="link flex items-center"><img src="./public/icon/en.svg" class="w-10 h-10 ml-5 mr-1 rounded-full object-cover mt-1" alt="English">ENG</a>
